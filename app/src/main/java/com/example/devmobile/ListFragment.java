...
public class ListFragment extends Fragment {
    ...
    private void fetchWeather(String ville){
        ...
        currentweatherservice.getForFiveD(ville,"9387d7732a59e17de90e4c91d32b1936").enqueue(new Callback<ResponseWeatherFiveD>() {
            @Override
            public void onResponse(Call<ResponseWeatherFiveD> call, Response<ResponseWeatherFiveD> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    for(Weather w:meteo.getListWeather()){
                        meteoDesc.setText(Float.toString(w.getMain().getTemp()));
                    }
